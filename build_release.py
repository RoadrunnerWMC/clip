...
# Everything highly specific to CLIP is in this section, to make it
# simpler to copypaste this script across all of my
# projects that use the same technologies (Reggie, Puzzle, BRFNTify,
# etc)

PROJECT_NAME = 'CLIP'
FULL_PROJECT_NAME = 'CLIP'
PROJECT_VERSION = '2.0'

WIN_ICON = None
MAC_ICON = None
MAC_BUNDLE_IDENTIFIER = 'com.example.clip'
